...
export default function HomeView({ onNavigateToLogin, logoUrl }: HomeViewProps) {
  ...
  return (
    <div className="min-h-screen bg-[#F8F8FA] font-sans">
      ...
      <section
        id="hero"
        className="relative min-h-screen w-full flex items-center overflow-hidden bg-[#05113b]"
      >
        {/* Full-Screen Background Carousel with extremely vivid, bright, and colorful images */}
        ...
        {/* Scroll hint */}
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-white/30 text-xs animate-bounce z-20">
